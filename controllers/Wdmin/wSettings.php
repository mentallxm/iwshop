    ...
    public function addAuth() {
        ...
        if ($pwd != '') {
            ...
            if ($id > 0) {
                ...
                if ($this->Dao->insert(TABLE_AUTH, 'admin_name, admin_account, admin_auth, admin_password,supplier_id')
                              ->values(array(
                                  $name,
                                  $acc,
                                  $auth,
            ...
            if ($id > 0) {
                ...
                if ($this->Dao->insert(TABLE_AUTH, 'admin_name, admin_account, admin_auth,supplier_id')
                              ->values(array(
                                  $name,
                                  $acc,
                                  $auth,
