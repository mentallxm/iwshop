...
if (scriptTag) {
    require.config({
        ...
        paths: {
            jquery: shoproot+'scripts/jquery-1.7.2.ext.min',
            lobibox: shoproot+'scripts/lobibox.min',
            bootstrap: shoproot+'scripts/bootstrap.min',
            util: 'Wdmin/util',
            Spinner: shoproot+'scripts/spin.min',
            highcharts: shoproot+'scripts/highcharts',
            fancyBox: 'lib/fancyBox/source/jquery.fancybox.pack',
            datatables: 'lib/DataTables/media/js/jquery.dataTables.min',
            jqPaginator: shoproot+'scripts/jqPaginator',
            provinceCity: 'lib/provinceCity',
            jUploader: shoproot+'scripts/jUploader.min',
            ...
            pagination: shoproot+'scripts/jquery.pagination.min',
            datetimepicker: shoproot+'scripts/jquery.datetimepicker.full.min',
            baiduTemplate: shoproot+'scripts/baiduTemplate',
            'jquery-mousewheel': shoproot+'scripts/jquery-mousewheel',
