...
<script data-main="{$docroot}static/script/Wshop/shop_credit_exchange_detail.js?v={$smarty.now}" src="http://apps.bdimg.com/libs/require.js/2.1.9/require.min.js"></script>
