...
<head>
    ...
    <link href="{$docroot}static/css/wshop_admin_index.css?v={$cssversion}" type="text/css" rel="Stylesheet"/>
    <link href="{$docroot}static/css/font-awesome.min.css" type="text/css" rel="Stylesheet"/>
    <script type="text/javascript" src="{$docroot}scripts/jquery-2.1.1.min.js"></script>
    <script type="text/javascript" src="{$docroot}scripts/bootstrap/3.3.4/bootstrap.min.js"></script>
