...
<a href="javascript:;" class="navItem" id="navitem11" rel='subnav11'>
        <span class="glyphicon glyphicon-briefcase" aria-hidden="true"></span><i class='label'>商户管理</i>
    </a>
    <div class='subnavs clearfix' id='subnav11'>
        <a id='__comlist' class='cap-nav-item' href='javascript:;' data-page="suppliers_list" data-nav="suppliers">商户列表</a>
...
{if $Auth.sett}
    ...
    <div class='subnavs clearfix' id='subnav7'>
        ...
        <a class='cap-nav-item' href='javascript:;' data-page="clear_cache" data-nav="settings">清除缓存</a>
    </div>
{/if}
