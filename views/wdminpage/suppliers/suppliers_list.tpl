...
<div id="DataTables_Table_0_filter" class="dataTables_filter clearfix">
    <div class="button-set" style="margin-top: 13px;margin-right: 13px;">
        ...
        <a class="button" data-toggle="modal" data-target="#modal_modi_supplier" data-id="0">添加商户11</a>
    </div>
</div>
<table class="dTable">
    <thead>
...
{include file='../modal/supplier/modal_modi_supplier.html'}
{include file='../modal/supplier/modal_dele_supplier.html'}
